    ...
    $(function () {
        ...
        var Core = {
            ...
            build: function () {
                ...
                if ($('.item_statistic').length)
                    this.events.statisticCounters();
            ...
            sliders: function () {
                ...
                if ($(sliderCollection[4]).length) {
                    ...
                    setTimeout(function () {
                        $(sliderCollection[4]).iosSlider(iosOptions)
                    }, 100);
            ...
            plugins: function () {
                ...
                //tabs
                if ($(pluginsCollection[0]).length)
                    $(pluginsCollection[0]).easytabs({tabActiveClass: "active"});
                //accordion
                if ($(pluginsCollection[1]).length)
                    $(pluginsCollection[1]).accordion();
                // calendar
                if ($(pluginsCollection[2]).length)
                    $(pluginsCollection[2]).createCalendar();
                //jackbox
